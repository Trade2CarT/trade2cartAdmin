        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
            <div className="w-full max-w-sm mx-auto bg-white p-8 rounded-2xl shadow-lg text-center">
                ...
                <div className="flex justify-center gap-2 mb-6">
                    {otp.map((data, index) => (
                        <input
                            ...
                            type="text"
                            maxLength="1"
                            className="w-12 h-14 text-center text-2xl font-semibold border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-brand-500"
                            value={data}
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-brand-600 text-white font-bold rounded-lg hover:bg-brand-700 transition-transform transform hover:scale-105 disabled:bg-gray-400"
                >
