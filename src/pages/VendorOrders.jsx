...
const VendorOrders = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto">
            <button onClick={() => navigate('/vendor-billing')} className="text-sm text-brand-600 hover:underline mb-4">&larr; Back to Vendors</button>
                                ...
                                <tr key={assignment.id} className="bg-white border-b hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-brand-600 text-white font-bold rounded-lg text-xs hover:bg-brand-700 transition-colors">
                                            Create Bill
                                        </button>
                                    </td>
                                </tr>
